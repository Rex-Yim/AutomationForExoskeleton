...
The present work addresses software-centric rapid prototyping on IMU data with MATLAB-based fusion and classification~\cite{zhang2012,chereshnev2018}, targeting $>90$\% accuracy on public gait data as a stepping stone toward hardware integration. It directly targets gaps repeatedly identified in recent reviews~\cite{pesenti2021,kermavnar2021,troster2022,lin2025}:
\begin{itemize}
