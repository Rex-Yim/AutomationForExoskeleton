...
\section[Overview of back-support exoskeletons for MMH]{Back-Support Exoskeletons for MMH}
...
\section{Actuation Systems (Cable-Driven and SEAs)}
...
\section{Representative Exoskeletons (Summary Table)}
\begin{table}[htbp]
  \centering
  \footnotesize
  ...
  \begin{tabularx}{\linewidth}{@{}>{\raggedright\arraybackslash}p{2.65cm}>{\raggedright\arraybackslash}p{1.45cm}>{\raggedright\arraybackslash}p{1.5cm}>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X@{}}
    \toprule
